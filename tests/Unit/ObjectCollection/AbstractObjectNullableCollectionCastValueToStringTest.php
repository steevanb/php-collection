...
final class AbstractObjectNullableCollectionCastValueToStringTest extends TestCase
{
    public function testStdClass(): void
    {
        $collection = new class extends AbstractObjectNullableCollection
        {
    ...
    public function testStringable(): void
    {
        $collection = new class extends AbstractObjectNullableCollection
        {
            ...
            public function callCastValueToString(): string
            {
                return $this->castValueToString(new class {
    ...
    public function testNull(): void
    {
        $collection = new class extends AbstractObjectNullableCollection
        {
            ...
            public function callCastValueToString(): string
            {
                return $this->castValueToString(null);
            }
        };

        static::assertSame('NULL', $collection->callCastValueToString());
    }
