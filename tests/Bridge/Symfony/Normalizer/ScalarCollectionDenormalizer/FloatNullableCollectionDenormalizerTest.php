...
final class FloatNullableCollectionDenormalizerTest extends TestCase
{
    /**
    ...
    public function testDenormalize(): void
    {
        ...
        /** @var FloatNullableCollection $collection */
        $collection = $serializer->denormalize([1.0, 2.2, null], FloatNullableCollection::class);
